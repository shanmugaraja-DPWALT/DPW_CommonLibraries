 ...
 *-----------------------------------------------------------------------------------------------
 *     1.0		    Vinod Sasi                 07-12-2023                           Created	   						  
 *-----------------------------------------------------------------------------------------------
 */
...
namespace GOGCoreDataLayer
{
    public class CPostgresSQLDataAccessHelper : IGOGDataAccessHelper, System.IDisposable
    {
        /// <summary>
                            ...
                            string srParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Npgsql.NpgsqlParameter(srParamName, srParamValue);
                            ...
                            byte[] barParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Npgsql.NpgsqlParameter (srParamName, barParamValue);
                if (null == oDbParameter)
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION);
                            ...
                            float fParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Npgsql.NpgsqlParameter(srParamName, fParamValue);
                if (null == oDbParameter)
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION);
                            ...
                            double dbParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Npgsql.NpgsqlParameter(srParamName, dbParamValue);
                if (null == oDbParameter)
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION);
                            ...
                            object oParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Npgsql.NpgsqlParameter(srParamName, oParamValue);
                if (null == oDbParameter)
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION);
                            ...
                            int nParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Npgsql.NpgsqlParameter(srParamName, nParamValue);
                if (null == oDbParameter)
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION);
                            ...
                            long lParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Npgsql.NpgsqlParameter(srParamName, lParamValue);
                if (null == oDbParameter)
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION);
                            ...
                            bool bParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Npgsql.NpgsqlParameter(srParamName, bParamValue);
                if (null == oDbParameter)
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION);
                            ...
                            System.DateTime dtParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Npgsql.NpgsqlParameter(srParamName, dtParamValue);
                if (null == oDbParameter)
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION);
                       ...
                       decimal deParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Npgsql.NpgsqlParameter(srParamName, deParamValue);
                if (null == oDbParameter)
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION);
                        ...
                        System.Data.DataTable tblParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Npgsql.NpgsqlParameter(srParamName, tblParamValue);
                if ( null == oDbParameter )
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION);
        ...
        public bool OpenConnection()
        {
            try
            {
                ...
                if (null == _oConnection)
                {
                    _oConnection = new Npgsql.NpgsqlConnection( ) ;
                    if (null == _oConnection)
                    {
                        throw new HCDataLayerException(
                            ...
                            System.Collections.ArrayList alInputParams, out System.Collections.ArrayList alOutputParams)
        {
            ...
            try
            {
                ...
                System.Data.Common.DbDataAdapter da = new Npgsql.NpgsqlDataAdapter();
                if (null == da)
                {
                    throw new HCDataLayerException(
            ...
            try
            {
                switch (enReturnType)
                {
                    ...
                    case EnumDBLayerReturnTypes.TYPE_DATAADAPTER:
                        da = new Npgsql.NpgsqlDataAdapter( ) ;
                        if (null == da)
                        {
                            throw new HCDataLayerException(
                                 "Cannot create data adapter object.", EnumErrorTypes.DATABASE_EXCEPTION);
        ...
        public void SetDBExceptionNumber(System.Data.Common.DbException exDb)
        {
            ...
            Npgsql.NpgsqlException ex = exDb as Npgsql.NpgsqlException;
            if (null != ex) _nErrorNumber = -1 ;/*Not supported by postgress sql*/
