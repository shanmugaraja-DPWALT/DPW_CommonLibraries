...
namespace GOGCoreDataLayer
{
    class CMSSQLDataAccessHelper : IGOGDataAccessHelper, System.IDisposable
    {
        /// <summary>
                            ...
                            string srParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.SqlClient.SqlParameter(srParamName, srParamValue);
                            ...
                            byte[] barParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.SqlClient.SqlParameter(srParamName, barParamValue);
                if (null == oDbParameter)
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION);
                            ...
                            float fParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.SqlClient.SqlParameter(srParamName, fParamValue);
                if (null == oDbParameter)
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION);
                            ...
                            double dbParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.SqlClient.SqlParameter(srParamName, dbParamValue);
                if (null == oDbParameter)
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION);
                            ...
                            int nParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.SqlClient.SqlParameter(srParamName, nParamValue);
                if (null == oDbParameter)
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION);
                            ...
                            long lParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.SqlClient.SqlParameter(srParamName, lParamValue);
                if (null == oDbParameter)
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION);
                            ...
                            bool bParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.SqlClient.SqlParameter(srParamName, bParamValue);
                if (null == oDbParameter)
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION);
                            ...
                            System.DateTime dtParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.SqlClient.SqlParameter(srParamName, dtParamValue);
                if (null == oDbParameter)
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION);
                       ...
                       decimal deParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.SqlClient.SqlParameter(srParamName, deParamValue);
                if (null == oDbParameter)
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION);
                        ...
                        System.Data.DataTable tblParamValue, System.Data.ParameterDirection enParamDirection)
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.SqlClient.SqlParameter(srParamName, tblParamValue);
                if ( null == oDbParameter )
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION);
        ...
        public bool ExecuteTableOperations(string srQuery)
        {
            ...
            try
            {
                ...
                ////////////////////////Start - 1///////////////////////////////////////////////
                //Vinod Changed to Avoid Transaction Related Issue - InvalidOperation .......
                //oCommand = new Microsoft.Data.SqlClient.SqlCommand();
        ...
        public bool OpenConnection()
        {
            try
            {
                ...
                if (null == _oConnection)
                {
                    _oConnection = new Microsoft.Data.SqlClient.SqlConnection();
                    if (null == _oConnection)
                    {
                        throw new HCDataLayerException(
                            ...
                            System.Collections.ArrayList alInputParams, out System.Collections.ArrayList alOutputParams)
        {
            ...
            try
            {
                ...
                System.Data.Common.DbDataAdapter da = new Microsoft.Data.SqlClient.SqlDataAdapter();
                if (null == da)
                {
                    throw new HCDataLayerException(
                ...
                System.Data.Common.DbCommand oCommand, EnumDBLayerReturnTypes enReturnType)
        {
            _sErrorString = "Error Success" ;
            _enCustomErrorType = EnumErrorTypes.NOTSET ;
            oCommand.CommandTimeout = 180 ;//Set command time out to 3 minutes.
            ...
            try
            {
                switch (enReturnType)
                {
                    ...
                    case EnumDBLayerReturnTypes.TYPE_DATAADAPTER:
                        da = new Microsoft.Data.SqlClient.SqlDataAdapter();
                        if (null == da)
                        {
                            throw new HCDataLayerException(
                                 "Cannot create data adapter object.", EnumErrorTypes.DATABASE_EXCEPTION);
        ...
        public void SetDBExceptionNumber(System.Data.Common.DbException exDb)
        {
            ...
            Microsoft.Data.SqlClient.SqlException ex = exDb as Microsoft.Data.SqlClient.SqlException;
