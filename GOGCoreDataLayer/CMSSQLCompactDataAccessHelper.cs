...
{
    public class CMSSQLCompactDataAccessHelper : IGOGDataAccessHelper, System.IDisposable
    {
        /// <summary>
        ...
        /// <summary>
        /// String variable to store the external connection string.
        /// </summary>
        private string _srConnectionString = string.Empty ; 
        ...
        /// </summary>
        private System.Data.Common.DbConnection _oConnection = null ;

        /// <summary>
        /// Declaring transaction object
        /// </summary>
        private System.Data.Common.DbTransaction _oTransaction = null;
        ...
        /// </summary>
        private System.Data.Common.DbDataReader _oDataReader = null;
                            ...
                            string srParamValue, System.Data.ParameterDirection enParamDirection )
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.Sqlite.SqliteParameter( srParamName, srParamValue ) ;
                            ...
                            byte[ ] barParamValue, System.Data.ParameterDirection enParamDirection )
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.Sqlite.SqliteParameter( srParamName, barParamValue );
                if( null == oDbParameter )
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION );
                            ...
                            float fParamValue, System.Data.ParameterDirection enParamDirection )
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.Sqlite.SqliteParameter( srParamName, fParamValue );
                if( null == oDbParameter )
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION );
                            ...
                            double dbParamValue, System.Data.ParameterDirection enParamDirection )
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.Sqlite.SqliteParameter( srParamName, dbParamValue );
                if( null == oDbParameter )
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION );
                            ...
                            int nParamValue, System.Data.ParameterDirection enParamDirection )
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.Sqlite.SqliteParameter( srParamName, nParamValue );
                if( null == oDbParameter )
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION );
                            ...
                            long lParamValue, System.Data.ParameterDirection enParamDirection )
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.Sqlite.SqliteParameter( srParamName, lParamValue );
                if( null == oDbParameter )
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION );
                            ...
                            bool bParamValue, System.Data.ParameterDirection enParamDirection )
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.Sqlite.SqliteParameter( srParamName, bParamValue );
                if( null == oDbParameter )
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION );
                            ...
                            System.DateTime dtParamValue, System.Data.ParameterDirection enParamDirection )
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.Sqlite.SqliteParameter( srParamName, dtParamValue );
                if( null == oDbParameter )
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION );
                       ...
                       decimal deParamValue, System.Data.ParameterDirection enParamDirection )
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.Sqlite.SqliteParameter( srParamName, deParamValue );
                if( null == oDbParameter )
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION );
                        ...
                        System.Data.DataTable tblParamValue, System.Data.ParameterDirection enParamDirection )
        {
            ...
            try
            {
                oDbParameter = new Microsoft.Data.Sqlite.SqliteParameter( srParamName, tblParamValue );
                if( null == oDbParameter )
                {
                    throw new HCDataLayerException(
                        "Cannot create DB parameter object.", EnumErrorTypes.DATABASE_EXCEPTION );
        ...
        public bool ExecuteTableOperations( string srQuery )
        {
            ...
            try
            {
                ...
                oCommand = new Microsoft.Data.Sqlite.SqliteCommand( );
                if( null == oCommand )
                {
                    throw new HCDataLayerException(
        ...
        {
            if ( _srConnectionString == string.Empty ) _srConnectionString = _oDataLayer.ConnectionString ;
            ...
            try
            {
                ...
                if( null == _oConnection )
                {
                    _oConnection = new Microsoft.Data.Sqlite.SqliteConnection( ) ;
                    if( null == _oConnection )
                    {
                        throw new HCDataLayerException(
                ...
                _oConnection.ConnectionString = _srConnectionString ;
                _oConnection.Open( );
        ...
        {
            _srConnectionString = srConnectionString ;
            try
            {
                // IF CONNECTION ALREADY OPEND RETURN TRUE.
                if( null != _oConnection && System.Data.ConnectionState.Open == _oConnection.State )
        ...
        public object ExecuteQuery( string srQuery, EnumDBLayerReturnTypes enReturnType )
        {
            ...
            object oResult = null;
            System.Data.Common.DbCommand oCommand = new Microsoft.Data.Sqlite.SqliteCommand( );
            try
            {
                if( null == oCommand )
                {
                        ...
                        EnumDBLayerReturnTypes enReturnType, System.Collections.ArrayList alInputParams )
        {
            ...
            try
            {
                ...
                System.Data.Common.DbDataAdapter da = null;//new Microsoft.Data.Sqlite.SqliteDataAdapter( ) ;
                System.Data.DataSet ds = new System.Data.DataSet( );
        ...
        private object ExecuteCommand(
                System.Data.Common.DbCommand oCommand, EnumDBLayerReturnTypes enReturnType )
        {
            _sErrorString = "Error Succes" ;
            _enCustomErrorType = EnumErrorTypes.NOTSET ;
            ...
            try
            {
                switch( enReturnType )
                {
                    ...
                    case EnumDBLayerReturnTypes.TYPE_DATAADAPTER:
                        da = null; // new Microsoft.Data.Sqlite.SqliteDataAdapter( );
                        if( null == da )
                        {
                            throw new HCDataLayerException(
                                 "Cannot create data adapter object.", EnumErrorTypes.DATABASE_EXCEPTION );
        ...
        public void SetDBExceptionNumber( System.Data.Common.DbException exDb )
        {
            ...
            //Not compactible - Need to Check
            //Microsoft.Data.Sqlite.SqliteException ex = exDb as Microsoft.Data.Sqlite.SqliteException ;
